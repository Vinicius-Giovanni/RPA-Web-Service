...
PENDING_FISCAL_HISTORICO_CSV = Path(f'C:/Users/{ID_EMPLOYEE}/OneDrive - Grupo Casas Bahia S.A/Sala PCP - Online_A.B.S - Data Lakehouse/Gold (Business Layer)/REL_MERC_N_RECEBIDA/BASE_INDICADORES_MERC_N_RECEBIDA.csv')
